...
import { changePassword, getUserSettings, updateNotificationSettings, updateAccountSettings } from '@/lib/auth/api';
  ...
  useEffect(() => {
    const loadSettings = async () => {
      ...
      try {
        ...
        setNotifications({
          emailAlerts: settings.notifications.email_alerts,
          pushNotifications: settings.notifications.push_notifications,
          weeklyReports: settings.notifications.weekly_reports,
          systemUpdates: settings.notifications.system_updates,
          dataProcessing: settings.notifications.data_processing,
          securityAlerts: settings.notifications.security_alerts
        });
        setAccountSettings({
          language: settings.account.language,
          timezone: settings.account.timezone,
          dateFormat: settings.account.date_format,
  ...
  const saveNotifications = async () => {
    ...
    try {
      await updateNotificationSettings({
        ...
        data_processing: notifications.dataProcessing,
  ...
  const saveAccountSettings = async () => {
    ...
    try {
      await updateAccountSettings({
        ...
        date_format: accountSettings.dateFormat,
              ...
              <form onSubmit={handlePasswordSubmit} className="space-y-6">
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    className="bg-[#2dd4bf] hover:bg-[#14b8a6] disabled:bg-gray-600 text-black font-semibold px-6 py-3 rounded-lg flex items-center gap-2 transition-colors"
                  >
                    {savingPassword ? (
                      <>
